    ...
    this.innerHTML = `
      <nav class="absolute w-full z-10 py-4">
        <div class="container flex justify-between items-center">
          ...
          <form class="rounded-lg border w-96 flex justify-between border-white px-4 py-2">
            <input class="bg-transparent border-none p-0 text-gray-100 placeholder:text-gray-100 focus:ring-0" type="text" placeholder="What do you want to watch?">
